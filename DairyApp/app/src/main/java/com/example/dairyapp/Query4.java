...
public class Query4 extends AppCompatActivity {
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(ans))
                    Toast.makeText(Query4.this, "Please enter something", Toast.LENGTH_SHORT).show();

                else{
                    DatabaseReference ref= FirebaseDatabase.getInstance().getReference("Users").child(uid).child("3");
                    ref.child(todaydate).setValue(ans);
                    Intent intent=new Intent(Query4.this,Query5.class);
